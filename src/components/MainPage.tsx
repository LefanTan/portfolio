...
export const MainPage = memo(() => {
  ...
  return (
    <main
      ...
      className="bg-transparent w-screen h-screen p-0 whitespace-nowrap flex overflow-x-scroll overflow-y-hidden snap snap-x snap-mandatory"
    >
      {!isMobile && (
        <div className="pointer-events-none fixed w-screen h-screen flex items-center justify-between z-40 p-3">
