    ...
    <div className="bg-deep-blue w-fit lg:w-full h-fit lg:h-full flex flex-col justify-center items-center relative py-4">
      <div style={{ width: "21cm" }} className="flex items-center py-2">
        ...
        <button
          ...
          className="text-dark-green bg-off-white rounded-md ml-3 px-2 py-1 flex items-center justify-center transition duration-100 hover:bg-off-white-hover transform active:scale-90"
        >
          <FaPrint className="h-full w-5 mr-2" />
          Print
        </button>
      </div>
      <div className="resume">
        ...
        <div className="flex flex-col w-4/6 pr-5">
          ...
          <div className="row-span-2 col-span-2">
            ...
            <div className="flex">
              <h2 className="description">
                BSc Computer Science Specializing in Software Practice
              </h2>
          ...
          <div className="row-span-5 col-span-2 mt-5">
            ...
            <ul className="list">
              ...
              <li>
                ...
                are deployed to the Ocolus Devices, HP Reverb G2, and any other
                OpenXR compatible devices
              </li>
              <li>
                Responsible for designing an interactive and highly functional
                UI/UX for our VR application
              </li>
            </ul>

            <h2 className="title mt-1">
              University of Alberta's Students' Union
            </h2>
            <div className="flex">
            ...
            <ul className="list">
              <li>
                Oversee all operations of Safewalk, a volunteer program with
                100+ volunteers that operates to ensure campus safety by
                providing safe passage home
              </li>
              <li>
                Ensure effective operation of the Safewalk program including
                managing all volunteers, running interviews, training,
                evaluating and supervising
              </li>
              <li>
                Problem solving, collaboration and leadership skills is crucial
                in this position
              </li>
            </ul>
          </div>
          ...
          {/* Projects */}
          <div className="row-span-5 col-span-2 mt-5 mb-20">
            ...
            <ul className="list">
              <li>
                Allows friends from all over the world to play the popular card
                game, Big2 online
              </li>
              <li>
                A basic lobby system where players can join a room based on a
            ...
            <ul className="list">
              <li>
                Interactive, online wiki that shows users different ways of
                playing guitar chords of different voicing.
              </li>
              <li>
                Chords generated are clickable, playing the exact note you
                clicked
              </li>
              <li>
                Scales page shows users how to play every type of scales on the
                guitar in the CAGED system
              </li>
            </ul>
            ...
            <ul className="list">
              <li>
                A full stack android app made to track your daily emotions in a
                diary format.
              </li>
              <li>
                Users are able to create an entry that tracks location, mood, a
                photo, descriptions etc
              </li>
              <li>
        ...
        <div className="flex flex-col h-full w-2/6">
          ...
          <div className="row-span-3 relative h-fit mb-5">
            <div className="bg-dark-green p-4 pb-10">
              <h1 className="small-light-text font-extralight text-5xl">
                Lefan Tan
              </h1>
              <p className="font-main text-dark-green bg-off-white rounded-lg leading-none text-lg font-sm pl-2 py-1.5 mt-2">
                Software Developer, Designer
              </p>
              <div className="flex items-center mt-2">
                <HiMail className="text-off-white mr-2" />
                <p className="small-light-text">
                  <a href="mailto:lefantan@hotmail.com">lefantan@hotmail.com</a>
                </p>
              </div>
              <div className="flex items-center mt-2">
          ...
          <div className="row-span-1 p-1 h-fit mb-5">
            ...
            <p className="font-main text-dark-green text-sm">
              A Dedicated, passionate programmer with a strong eager to learn.
              While I take an interest in designing front-end UI, I'm happy to
              take on task of all sorts. I'm looking for a position that will
              provide me with an opportunity for me to grow professionally and
              personally.
            </p>
          </div>
          ...
          <div className="row-span-3 h-fit mb-5">
            ...
            <div className="flex flex-wrap">
              ...
              <h1 className="languages">Laravel</h1>
          ...
          <div className="row-span-1 mt-auto w-full flex items-center">
            <h1 className="font-main font-semibold w-full text-off-white text-sm bg-dark-green px-3 py-2">
              Last Updated: 14 Obtober 2021
            </h1>
          </div>
        </div>
      </div>
