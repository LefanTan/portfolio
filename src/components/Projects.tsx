    ...
    return (
        <motion.div variants={parentVariant} initial='hidden' animate='visible' className={`${props.className} flex flex-col items-center justify-start w-full lg:w-1/3 h-full m-5`}>
            ...
            <div className="flex flex-col h-fit">
                ...
                <motion.p variants={opacityChildrenVariant} className="whitespace-pre-line font-main text-off-white text-xs font-light mt-3">{props.description}</motion.p>
                <div className="w-full flex justify-start items-center whitespace-pre mt-1">
                    ...
                    <a href={props.github} target="_blank" rel="noopener noreferrer" className="w-6 ml-auto transition duration-100 transform hover:scale-110 active:scale-100">
                    ...
                    {props.website && <a href={props.website} target="_blank" rel="noopener noreferrer" className="w-5 ml-1 transition duration-100 transform hover:scale-110 active:scale-100">
