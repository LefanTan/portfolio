        ...
        <div id="aboutme" ref={refHandler} className={`${className} bg-transparent`}>
            <div className="bg-deep-blue w-screen h-screen flex justify-center items-center overflow-hidden relative">
                <motion.div
                 ...
                 {/* <motion.div
                    animate={{ y: transition ? '50%' : '200%' }} initial={{ y: `200%`, rotate: '-15deg'}} transition={{ type: "spring", duration: 2, delay: 1 }}
                    className="bg-red absolute top-1/4 bottom-0 left-0 -right-1/2 z-10"/> */}
                <div className="w-full h-full flex justify-center items-center z-50">
                    <motion.div className="w-full lg:w-8/12 h-full flex flex-col lg:flex-row justify-center items-center"
                        animate="visible"
                        ...
                        <div className="bg-off-white w-11/12 lg:w-3/4 h-4/5 mb-5 lg:mb-0 flex flex-col shadow-hard p-5">
                            <motion.h1 variants={childrenVariant} className="text-dark-grey-active font-main font-light text-4xl mb-4">About me</motion.h1>
                            <motion.p variants={childrenVariant} className="text-dark-grey-active h-fit font-main font-light text-sm whitespace-pre-line">
